...
Attribution rules:
  ...
  - Time-bounded attribution: public participant (fastly.com) and public participant (gmail)
  ...
  - Related CAs treated as same org: Bundesdruckerei/reference entity, reference entity/QuoVadis
...
CA_SUMMARY_ALIASES = {
    "DigiCert":                 {"digicert", "quovadis", "quo vadis"},  # reference entity acquired QuoVadis
    "HARICA":                   {"harica"},
...
ORG_CANONICAL = {
    ...
    "geotrust":             None,   # absorbed into reference entity
    "thawte":               None,   # absorbed into reference entity
...
def main():
    ...
    ballots_cache = load_json(PIPELINE_DIR / "cabforum_ballots.json", {})
    ...
    try:
        ...
        print(f"  WARNING: could not load distrusted.json: {e}", file=__import__("sys").stderr)
        print(f"  WARNING: distrusted CAs will appear as active participants in community engagement",
