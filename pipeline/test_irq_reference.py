...
Reference set (hand-labeled from reading threads):
  ...
  reference entity 1623384 — EXPECT arc=stalled,    pc=deflected
  reference entity 1609828 — EXPECT arc=stalled
  reference entity 1890123    — EXPECT arc=stalled
  reference entity 1901270    — EXPECT arc=stalled
  reference entity 1319609       — EXPECT arc=healthy
"""
...
REFERENCE = [
    {
        ...
        "expected_pc":     "ignored",    # public participant raised pattern; CA asked to close
