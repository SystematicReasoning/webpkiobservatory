...
def main():
    ...
    # CRL health outputs are served as standalone runtime JSON files.
    # Do not embed them in ui_bundle.json: the daily CRL artifact can exceed
    # 100 MB, which pushes Vite/Rollup past the default Node heap limit.
    crl_health_data = None
    crl_health_history = None
    crl_health_events = None
