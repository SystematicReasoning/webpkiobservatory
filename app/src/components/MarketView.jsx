...
const MarketView = () => {
  ...
  return (
    <div>
      ...
      <Card>
        <CardTitle sub="Unexpired precertificates by CA owner from Certificate Transparency logs via crt.sh. Includes HHI market concentration score.">
          ...
          return (
            <>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, alignItems: 'center' }}>
                <div style={{ flex: '0 1 400px', minWidth: 0, maxWidth: 400 }}>
                ...
                <div style={{ flex: '0 0 220px', display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  >
                    Top 3 CAs issued {top3Pct}% of all certificates
                  </div>
                </div>
              </div>
            </>
      ...
      <Card>
        <CardTitle sub="Number of CA organizations headquartered in each country, sized by total certificate issuance volume. One organization may operate multiple root certificates.">
