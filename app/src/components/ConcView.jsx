...
import { COLORS, FONT_MONO, FONT_SANS , ALPHA } from '../constants';
...
const ConcView = () => {
  ...
  return (
    <div>
      ...
      {/* ── Cumulative S-curve ── */}
      <Card>
        <CardTitle sub="Cumulative market share as CAs are added in rank order. A steep curve that reaches 90%+ within the first few CAs means the ecosystem has extreme concentration — a handful of operators underpin the entire WebPKI.">
          Cumulative Concentration Curve
        </CardTitle>
        <ChartWrap height={220}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={areaData} margin={{ left: 8, right: 16, top: 5, bottom: 20 }}>
              <defs>
