...
const RootExpirationTimeline = ({ roots, caData }) => {
  ...
  return (
    <Card>
      <CardTitle sub="Root certificates sorted by expiration date. When a root expires, every certificate chain anchored to it must transition. Earlier expirations require more urgent CA coordination with subscribers.">
