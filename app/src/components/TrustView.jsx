...
const TrustView = () => {
  ...
  return (
    <div>
      ...
      <Card>
        <CardTitle sub="Root certificates by CA headquarters country. Number inside dot = root count (not CA organization count — one org may operate many roots). Color = how many of the 4 major trust stores include that CA.">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={entries} margin={{ left: 8, right: 16, top: 8, bottom: 8 }}>
                  ...
                  <XAxis
                    ...
                    tickLine={false}
                    interval={Math.ceil(entries.length / 5)}
      ...
      {(() => {
        ...
        return (
          <Card>
            <CardTitle sub="What certificate types each CA is authorized to issue (DV, OV, EV, S/MIME, Code Signing) and how much of total issuance each capability accounts for.">
              Capability Distribution
            </CardTitle>
            <div
              style={{
      ...
      <MethodologyCard>
        ...
        <MethodologyItem label="Disagreements">CAs trusted by some but not all root programs. Web coverage gap = sum of browser market share for stores that don't trust the CA. Sorted by gap — missing Chrome (~{(browserCoverage.chrome * 100).toFixed(0)}%) is the most impactful single-store exclusion.</MethodologyItem>
