...
import { COLORS, STORE_COLORS, FONT_MONO, FONT_SANS, COUNTRY_COORDS , ALPHA } from '../constants';
 ...
 * five standards bodies (NIST, ECRYPT-CSA, BSI, reference entity, NSA CNSA).
...
const CryptoView = () => {
  ...
  return (
    <div>
      ...
      {/* Algorithm split */}
      <Card>
        <CardTitle sub="Algorithm family and key size distribution across root certificates currently in the Chrome Root Store.">
      ...
      {/* Timeline */}
      <Card>
        <CardTitle sub="Root certificates by creation year and algorithm family. Shows when the ecosystem shifted from RSA to ECC.">Root Creation Timeline</CardTitle>
        <ChartWrap height={200}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={timeline} margin={{ left: 4, right: 10, top: 10, bottom: 20 }}>
      ...
      {/* Soonest expiring with algo data */}
      <Card>
        <CardTitle sub="Roots expiring soonest, with algorithm and standards body compliance. Expiration is a forcing function — the question is whether each CA is using it to upgrade to stronger primitives or simply re-issuing with the same weak algorithm.">
