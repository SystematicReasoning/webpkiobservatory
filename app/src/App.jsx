 ...
 *
 * All 15 tab components are lazy-loaded — only the active tab's code is
...
const TABS = [
  ...
  { id: 'policy',      l: 'Policy Compliance' },
  { id: 'governance',  l: 'Governance Risk' },
  { id: 'community',   l: 'Ecosystem Participation' },
  // Act 5 — Audit accountability
  { id: 'audit',       l: 'Audit Intelligence' },
];
    ...
    >
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: 'clamp(12px, 4vw, 28px) clamp(12px, 3vw, 24px)', overflowX: 'clip' }}>
        ...
        <Suspense fallback={<TabLoading />}>
          ...
          {tab === 'policy' && (
            <ErrorBoundary label="Policy Compliance">
              <PolicyView />
              <ComplianceView />
            </ErrorBoundary>
          )}
          ...
          {tab === 'audit' && (
            <ErrorBoundary label="Audit Intelligence">
              <AuditView />
            </ErrorBoundary>
          )}
        </Suspense>
    ...
    >
      ...
      >
        <span>
          ...
          {' · '}
          <a href="/llm_snapshot.json" download="webpki_observatory_llm_snapshot.json" style={{ color: COLORS.t3, textDecoration: 'underline' }}>LLM Snapshot</a>
          {' · '}
          <a href="/schema.json" download="webpki_observatory_schema.json" style={{ color: COLORS.t3, textDecoration: 'underline' }}>Schema</a>
        </span>
